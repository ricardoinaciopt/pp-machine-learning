...
def main(argv=None):
    ...
    if not quarto:
        parser.exit(1, 'Quarto is not installed. Install Quarto to render PDF/DOCX handouts.\n')
    ...
    try:
        ...
        parser.exit(error.returncode, 'Build stopped because a check or render failed.\n')
